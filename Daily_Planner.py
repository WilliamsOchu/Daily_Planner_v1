...
def add_task_staff():
    print('\n')
    print("\033[1mHello Proceed to add your tasks: \033[0m")
    print('\n')
    ...
    while True:  
        ...
        if new_task.lower()=="exit":
            ...
            print("\033[1m{}\033[0m has been added".format(new_task))
            time.sleep(0.25)
...
def remove_task_staff():
    print('\n')
    print('Select the task you want to remove')
    print(' '*15, "or")
    print("Type exit to return to start menu")
    print('\n')
    ...
    while True:
        ...
        try:    
            ...
            time.sleep(0.5)
            print("ERROR!!.....No such task in the list")
            print('\n')
...
def edit_task_staff():
    ...
    print('\n')
    print('Which task do you want to make changes to: ')
    print(' '*20, "or")
    print("Type exit to return to start menu")
    print('\n')
...
def view_task_staff():
    ...
    print('\n')
    print("Here is a list of all your tasks sceduled for \033[1m{}\033[0m".format(todays_date))
    print('\n')
    
    
    for task in tasks:
        task_num=tasks.index(task)
        print("{}. {}".format(task_num+1, task))
